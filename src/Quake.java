...
public class Quake extends Entity{
    public Quake(Point position, List<PImage> images, PathingStrategy pathingStrategy){
        super(EntityKind.QUAKE, Action.QUAKE_ID, position, images,
                0, 0, Action.QUAKE_ACTION_PERIOD, Action.QUAKE_ANIMATION_PERIOD, pathingStrategy);
    }
    @Override
